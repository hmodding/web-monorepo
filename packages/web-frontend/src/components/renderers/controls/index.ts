...
export { default as GoogleCaptchaRenderer } from './GoogleCaptchaRenderer.vue';
...
import { entry as googleCaptchaRendererEntry } from './GoogleCaptchaRenderer.vue';
