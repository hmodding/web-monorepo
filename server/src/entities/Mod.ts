...
export class Mod extends AbstractEntityWithCreatedAndUpdated {
  ...
  id!: string; //NO AUTOGENERATED ID but a slug
  ...
  @OneToMany(() => ModLike, modLike => modLike.mod)
  @JoinColumn({name: 'id', referencedColumnName: 'modId'})
  modLikes?: ModLike[];
...
//hooks
  ...
  @AfterLoad()
  calculateLikeCount() {
    this.likes = this.modLikes?.length || this.likes;
  }
